 ...
 * For simple convention-based view resolution, consider using {@link }.
 *
...
public class TilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
    ...
    public void setCompleteAutoload(boolean completeAutoload) {
        if (completeAutoload) {
            try {
                this.tilesInitializer = new TilesConfigurer.SpringCompleteAutoloadTilesInitializer();
            }
            catch (Throwable ex) {
     ...
     * <p>Specify {@link } to operate on specified preparer
    ...
    public void afterPropertiesSet() throws TilesException {
        ...
        if (this.tilesInitializer == null) {
            this.tilesInitializer = new TilesConfigurer.SpringTilesInitializer();
        }
    ...
    private class SpringTilesInitializer extends DefaultTilesInitializer {
        ...
        protected AbstractTilesContainerFactory createContainerFactory(ApplicationContext context) {
            return new TilesConfigurer.SpringTilesContainerFactory();
        }
    }
    ...
    private class SpringTilesContainerFactory extends BasicTilesContainerFactory {
        ...
        protected AttributeEvaluatorFactory createAttributeEvaluatorFactory(ApplicationContext context,
            ...
            if (tilesElPresent && JspFactory.getDefaultFactory() != null) {
                evaluator = new TilesConfigurer.TilesElActivator().createEvaluator();
            }
            else {
    ...
    private static class SpringCompleteAutoloadTilesInitializer extends CompleteAutoloadTilesInitializer {
        ...
        @Override
        protected AbstractTilesContainerFactory createContainerFactory(ApplicationContext context) {
            return new TilesConfigurer.SpringCompleteAutoloadTilesContainerFactory();
        }
    }
